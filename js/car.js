$(document).ready(function () {
    ...
    $.ajax({
        url: "http://129.151.122.18:8080/api/Gama/all",
        type: "GET",
    ...
    $("#upd-table-car").click(function () {
        var urlServicio = "http://129.151.122.18:8080/api/Car/all";
    ...
    $("#Agregar-Carro").click(function () {
        var urlServicio = "http://129.151.122.18:8080/api/Car/save";
...
function deleteCar(id){
    ...
    var urlServicio = "http://129.151.122.18:8080/api/Car/";
    urlServicio += id;
    $.ajax({
        url: urlServicio,
        type: "DELETE",
...
function updateCar(idCarro){
    $("#btn-upd-car").click(function () {
        var urlServicio = "http://129.151.122.18:8080/api/Car/update";
