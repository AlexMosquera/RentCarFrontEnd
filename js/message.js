$(document).ready(function () {
    ...
    $("#upd-message").click(function () {
        var urlServicio = "http://129.151.122.18:8080/api/Message/all";
    ...
    $("#Agregar-Mensaje").click(function () {
        var urlServicio = "http://129.151.122.18:8080/api/Message/save";
...
function deleteMessage(id){
    ...
    var urlServicio = "http://129.151.122.18:8080/api/Message/";
    urlServicio += id;
    $.ajax({
        url: urlServicio,
        type: "DELETE",
...
function updateMessage(idMessage){
    $("#btn-upd-message").click(function () {
        var urlServicio = "http://129.151.122.18:8080/api/Message/update";
