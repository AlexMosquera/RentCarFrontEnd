$(document).ready(function () {
    ...
    $("#upd-gama").click(function (){
        var urlServicio = "http://129.151.122.18:8080/api/Gama/all";
    ...
    $("#Add-Gama").click(function (){
        var urlServicio = "http://129.151.122.18:8080/api/Gama/save";
...
function deleteGama(id){
    ...
    var urlServicio = "http://129.151.122.18:8080/api/Gama/";
    urlServicio += id;
    $.ajax({
        url: urlServicio,
        type: "DELETE",
...
function updateGama(idGama){
    $("#btn-upd-gama").click(function () {
        var urlServicio = "http://129.151.122.18:8080/api/Gama/update";
