$(document).ready(function () {
    ...
    $("#Search-reservation").click(function () {
        $.ajax({
            url: "http://129.151.122.18:8080/api/Reservation/report-status",
            type: "GET",
    ...
    $.ajax({
        url: "http://129.151.122.18:8080/api/Client/all",
        type: "GET",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        cache: false,
    ...
    $.ajax({
        url: "http://129.151.122.18:8080/api/Car/all",
        type: "GET",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        cache: false,
    ...
    $("#Search-reservation").click(function () {
        ...
        if(startDate != "" && endDate != ""){
            $.ajax({
                url: "http://129.151.122.18:8080/api/Reservation/report-dates/"+startDate+"/"+endDate,
                type: "GET",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                cache: false,
    ...
    $("#upd-reservation").click(function (){
        var urlServicio = "http://129.151.122.18:8080/api/Reservation/all";
    ...
    $("#Add-Reservation").click(function (){
        var urlServicio = "http://129.151.122.18:8080/api/Reservation/save";
...
function deleteReservation(id){
    ...
    var urlServicio = "http://129.151.122.18:8080/api/Reservation/";
    urlServicio += id;
    $.ajax({
        url: urlServicio,
        type: "DELETE",
...
function updateReservation(idReservation){
    $("#btn-upd-reservation").click(function () {
        var urlServicio = "http://129.151.122.18:8080/api/Reservation/update";
