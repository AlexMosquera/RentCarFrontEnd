$(document).ready(function () {
    ...
    $.ajax({
        url: "http://129.151.122.18:8080/api/Reservation/report-clients",
        type: "GET",
        cache: false,
    ...
    $("#upd-client").click(function () {
        var urlServicio = "http://129.151.122.18:8080/api/Client/all";
    ...
    $("#Agregar-Cliente").click(function () {
        var urlServicio = "http://129.151.122.18:8080/api/Client/save";        
...
function deleteClient(id){
    ...
    var urlServicio = "http://129.151.122.18:8080/api/Client/";
    urlServicio += id;
    $.ajax({
        url: urlServicio,
        type: "DELETE",
...
function updateClient(idClient){
    $("#btn-upd-client").click(function () {
        var urlServicio = "http://129.151.122.18:8080/api/Client/update";
